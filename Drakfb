...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang \033[1;92m" +nama+ "\n\033[1;97mTerimakasih telah menggunakan tools ini Silahkan Masukan Username Dan Password NB:Login Fb Di Opera mini Biar Gak CP !!")
		time.sleep(1)
		loginSC()
...
def loginSC():
	os.system('clear')
	print"\033[1;97mSilahkan login USERNAME Dan Password Nya Jika Gk Tau Hubungi Wa Saya:083159336014\n"
	username = raw_input("\033[1;96m[*] \033[1;97mUsername \033[1;91m: \033[1;92m")
	password = raw_input("\033[1;96m[*] \033[1;97mPassword \033[1;91m: \033[1;92m")
	if username =="DICKY" and password =="TAMVAN":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/DICKYTAMVAN')
				menu()
